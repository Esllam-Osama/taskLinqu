...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E2739F727F4");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4E7738445");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85EF0F016E");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229D103220C");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D43CD4E6AC");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5DBA848AE");

            entity.ToTable("products", "production");

            entity.HasIndex(e => e.ProductName, "ix_products");

            entity.HasIndex(e => e.ProductName, "ix_products_product_name");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C46CCF46B");
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D31A794B54");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C7478F82F");
